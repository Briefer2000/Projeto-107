...
video = cv2.VideoCapture("C:/Users/marcy/Downloads/PRO_1-1_C107_AtividadeDoAluno1-main/PRO_1-1_C107_AtividadeDoAluno1-main/footvolleyball.mp4")
p1 = 530
p2 = 300
xs = []
ys = []
...
def goal_track(img, bbox):
    ...
    cv2.circle(img,(int(p1),int(p2)),2,(0,205,0))
    dist = math.sqrt(((c1-p1)**2+(c2-p2)**2))
    if(dist<=20):
        cv2.putText(img,"Acertou!",(300,90),cv2.FONT_HERSHEY_SCRIPT_SIMPLEX,0.7,(255,0,0),2)
    xs.append(c1)   
    ys.append(c2)
    for i in range(len(xs)-1):
        cv2.circle(img,(xs[i],ys[i]),2,(0,201,123),5)
while True:
